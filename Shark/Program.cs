...
namespace Shark
{
    internal class Program
    {
        public static void Main(string[] args)
        {
            ...
            students.Add(new Student("Рудоков", "Даниил", courses[0]));
            students.Add(new Student("Куликова", "Мария", courses[1]));
            students.Add(new Student("Архипова", "Ева", courses[2]));
            students.Add(new Student("Аксенов", "Роман", courses[3]));
            students.Add(new Student("Воробьев", "Эмиль", courses[0]));
                    ...
                    case 1:
                    {
                        ...
                        switch (choice)
                        {
                            ...
                            case 2:
                            {
                                ...
                                students.Add(new Student(surname, name, courses[whichCourse - 1]));
                                ...
                                if (lastItem != null && lastItem.LastName == surname && lastItem.FirstName == name && lastItem.Course.NumberOfCourse == whichCourse)
                                {
    ...
    public class Student : User
    {
        ...
        public Student(string lastName, string firstName, Course course)
